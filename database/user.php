...
function validateUser($username, $password) {
    $conn = connect();
    $q = "select u.*, ur.UserRoleId, ur.Title, r.IsMaster, r.Description as Role from user u, userrole ur, role r where ur.UserId = u.UserId and ur.RoleId = r.RoleId and ur.IsDeleted = 0 and u.Username = ? and BINARY u.Password = ?";
