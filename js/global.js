...
function profile(){
    displayEmployeeProfile(LOGGEDUSERID, LOGGEDUSERFIRSTNAME, LOGGEDUSERLASTNAME, LOGGEDUSERUSERNAME, LOGGEDUSERPHONE, LOGGEDUSERADDRESS, LOGGEDUSEREMAIL, LOGGEDUSERROLEIMAGE, LOGGEDUSERLASTACTIVEDATE);
}
