...
function profile(){
    displayEmployeeProfile(LOGGEDUSERID, LOGGEDUSERFIRSTNAME, LOGGEDUSERLASTNAME, LOGGEDUSERUSERNAME, LOGGEDUSERPHONE, LOGGEDUSERADDRESS, LOGGEDUSERROLEIMAGE, LOGGEDUSERLASTACTIVEDATE);
}
